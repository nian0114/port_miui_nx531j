...
mkdir -p workspace/output workspace/app final/data/miui final/data/app
...
cp -rf tools/META-INF1 final/META-INF
...
cd final
zip -q -r "../miui-$DEVICE-$VERSION-7.0.zip" 'boot.img' 'META-INF' 'system.img' 'root' 'firmware-update' 'data' 'RADIO'
cd ..
